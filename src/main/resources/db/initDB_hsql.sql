...
CREATE TABLE users (
  ...
  login       LONGVARCHAR NOT NULL UNIQUE,
...
CREATE SEQUENCE teachers_id_seq AS INTEGER START WITH 1;
CREATE TABLE teachers (
  id            INTEGER GENERATED BY DEFAULT AS SEQUENCE teachers_id_seq PRIMARY KEY,
  name          LONGVARCHAR NOT NULL,
  rank          LONGVARCHAR NOT NULL
);

CREATE SEQUENCE exams_id_seq AS INTEGER START WITH 1;
CREATE TABLE exams (
  id            INTEGER GENERATED BY DEFAULT AS SEQUENCE exams_id_seq PRIMARY KEY,
